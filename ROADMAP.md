...
- [ ] Give today's REST challenge the same answer-safe first-submission affordances as MCP: include a strategy hint and a shape-correct evaluation handoff/template while preserving the published schema, historical replay shape, and visitor-data boundary.
