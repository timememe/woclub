...
for(const [W,H] of [[800,600],[360,600]])for(const y of [0,20,80,999]){
 ...
 vm.runInContext(`let W=${W},H=${H},WORLD=1000,fx=500,fy=0,fz=500,T=4,target=null,fitted=false;`+camera+projection+focus,context);
...
console.log(JSON.stringify({source_commit:'working tree (original baseline: e335d39)',kind:'offline synthetic geometry; no world writes',results},null,2));
